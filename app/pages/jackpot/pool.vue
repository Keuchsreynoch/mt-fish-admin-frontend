...
//  Blacklist (stub — wire to real API once the backend endpoint exists)
      ...
      <div class="settings-flex-row mt-3">
        ...
        <v-card class="players-card" elevation="0">
          ...
          <v-tabs v-model="playerTab" density="compact" show-arrows="false" grow class="player-tabs">
            ...
            <v-tab class="text-capitalize text-body-medium " value="blacklist">{{ t('jackpot.blacklistMember') }}</v-tab>
          </v-tabs>
